...
ap.add_argument( "-i","--image", required=True,default="C:\\Users\\sunny\\OneDrive\\Desktop\\Data_science_app\\OCR-Identity-Cards\\pan\\pancard-sample.jpg" ,
...
try:
    ...
    fname = fname.rstrip()
    fname = fname.lstrip()
    fname = fname.replace("0", "S")
    fname = fname.replace("0", "O")
    fname = fname.replace("0", "G")
    fname = fname.replace("0", "I")
